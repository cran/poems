...
test_that("inheritance", {
  TestInheritedModel <- R6::R6Class("TestInheritedModel", inherit = GenericModel,
                                    ...
                                    active = list(attr2 = function(value) {if (missing(value)) { private$.attr2 } else { private$.attr2 <- value }})
  )
...
test_that("attribute get and set methods", {
  ...
  expect_equal(test_model$get_attribute_names(),
  ...
  expect_equal(test_model$get_attributes(), list(attr1 = "test2", attr2 = c(44, 55),
...
test_that("attribute aliases", {
  ...
  test_model <- TestInheritedModel$new(object_generator = TestInheritedModel, # for check only
                                       attribute_aliases = list(a1 = "attr1", a2_1 = "attr2[1]", a3_a = "attr3$a",
                                                                d_2 = "dog[2]", c_b = "cat$b"),
                                       params = list(attr1 = "test1", cat = list(a = "meow", b = "purr")),
                                       attr2 = c(11, 22, 33), attr3 = list(a = 9, b = 10), dog = c("woof", "bark"))
  expect_equal(test_model$get_attribute_aliases(),
               c("attr1", "attr2", "attr3", "dog", "cat", "error_messages", "warning_messages",
  ...
  expect_equal(test_model$get_attributes(c("attr2", "attr3", "dog", "cat")),
...
test_that("new cloning", {
  ...
  expect_equal(test_clone$get_attribute_names(),
               c("attr1", "attr2", "attr3", "dog", "cat", "error_messages", "warning_messages"))
